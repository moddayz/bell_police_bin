class ActionDisableLightPanelHeliCB_police : ActionContinuousBaseCB
{
...
class ActionHeliDisableLightPanelSIB_police: ActionContinuousBase
{
	void ActionHeliDisableLightPanelSIB_police()
	{
		m_CallbackClass = ActionDisableLightPanelHeliCB_police;
