class ActionEnableLightHeliCB_police : ActionContinuousBaseCB
{
...
class ActionHeliEnableLightSIB_police: ActionContinuousBase
{
	void ActionHeliEnableLightSIB_police()
	{
		m_CallbackClass = ActionEnableLightHeliCB_police;
