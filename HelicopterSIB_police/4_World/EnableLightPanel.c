class ActionEnableLightPanelHeliCB_police : ActionContinuousBaseCB
{
...
class ActionHeliEnableLightPanelSIB_police: ActionContinuousBase
{
	void ActionHeliEnableLightPanelSIB_police()
	{
		m_CallbackClass = ActionEnableLightPanelHeliCB_police;
